...
<task type="auto">
  ...
  <action>
    ...
    **Step 7: E2E tests (if Playwright is configured)**
  ...
  <done>
    TypeScript compiles clean. Grep audit confirms only protected strings remain. Unit tests pass. E2E test files updated with Plan selectors and assertions.
  </done>
</task>
