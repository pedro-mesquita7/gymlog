...
<task type="auto">
  ...
  <action>
    ...
    2. Wire into AnalyticsPage.tsx:
       ...
       - Display the subtitle below the CollapsibleSection title for "Exercise Progress" or below the exercise selector dropdown, before the chart
...
3. Week comparison subtitle appears below exercise progress section title
