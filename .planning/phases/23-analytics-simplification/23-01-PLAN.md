...
must_haves:
  truths:
    ...
    - "Streak card no longer appears in summary stats"
...
<task type="auto">
  ...
  <action>
    ...
    7. Update SummaryStats type in src/types/analytics.ts:
       - Remove `streakWeeks: number` field from the SummaryStats interface, keeping `totalWorkouts`, `totalVolumeKg`, `totalPrs`
