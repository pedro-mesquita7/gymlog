...
Add necessary imports (useState). Style with Tailwind for dark theme consistency.
  </action>
...
- Flat checkbox list for exercise selection (per CONTEXT.md decision)
  ...
  <verify>Component renders form. Zod validation triggers on submit. Drag-drop reorders exercises.</verify>
  <done>TemplateBuilder provides full form with validation, drag-drop ordering, checkbox exercise selection</done>
</task>
