...
6. Add Dialog action buttons inside Dialog children. Structure: `<Dialog><p>description</p><div className="flex gap-2 mt-4"><button className="bg-bg-tertiary ...">Cancel</button><button className="gradient/error ...">Confirm</button></div></Dialog>`. Cancel calls the respective `setShow*Dialog(false)`.
