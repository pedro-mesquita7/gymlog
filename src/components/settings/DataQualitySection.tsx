    ...
    <section>
      ...
      <div className="bg-bg-secondary rounded-lg p-4 space-y-4">
        ...
        <button
          onClick={runChecks}
          disabled={isRunning}
          className="w-full py-3 px-4 bg-accent hover:bg-accent/90 disabled:bg-bg-tertiary rounded-lg font-medium transition-colors text-black disabled:text-text-muted"
        >
